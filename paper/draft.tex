...
\affil[4]{jeyhun.karimov@dfki.de} 
\affil[5]{\{rabl, asterios.katsifodimos, volker.markl\}@tu-berlin.de}
\affil[6]{samarev@acm.org}
\affil[7]{henri.heiskanen@rovio.com}

\setlength{\textfloatsep}{0.4cm}  %% Or whatever length
\setlength{\abovecaptionskip}{0.5cm} % Or whatever length
...
\end{scriptsize}  % vldb_sample.bib is the name of the Bibliography in this case
